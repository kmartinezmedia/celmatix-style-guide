angular.module("styleGuide", [ "ngLodash" ]).config(function($httpProvider) {
    ...
    $scope.sections = [ {
        ...
        image: "../img/info.png",
        label: "Kate & John have been trying to conceive for the past 12 months. They were referred by Dr. Reina.",
        button: "View"
    }, {
        index: 1,
        heading: "Patient Intake",
        image: "../img/intake.png",
        label: "Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua.",
        button: "View"
    }, {
        index: 2,
        heading: "Appointment",
        ...
        index: 5,
        heading: "Polaris Report",
        image: "../img/polaris.png",
        label: "Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua.",
        button: "View"
    } ];
    ...
    return {
        ...
        link: function(scope, elem, attrs) {
            elem.bind("click", function() {
                ...
                var id = elem[0].id;
                var card = document.getElementById(id);
                move("#heading_" + scope.index).set("text-align", "left").set("padding-left", "70px").end();
                move("#image_" + scope.index).set("display", "inline-block").set("position", "absolute").set("top", "25px").set("width", "60px").end();
                move("#button_" + scope.index).set("position", "absolute").set("top", "30px").set("right", "80px").end();
                move(card).set("width", parentWidth + "px").end();
            });
        }
    };
